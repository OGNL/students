        ...
        <div class="row">
            ...
            <section>
                <div class="col-lg-8 col-lg-offset-2">
                    ...
                    <form id="defaultForm" method="post" class="form-horizontal" action="${pageContext.request.contextPath}/score/doupdate.action">
                       <input type="hidden" name="scoreId" value="${sco.scoreId}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-5">
                                <input id="stuName" type="text" class="form-control" name="stuName" readonly="readonly" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-5">
                                <input id="xxds" type="text" class="form-control" name="xxds" />
                            </div>
                        </div>
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-lg-5">
                                <input id="computer" type="text" class="form-control" name="computer" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-5">
                                <input id="mzd" type="text" class="form-control" name="mzd" />
                            </div>
                        </div>
                            <div class="form-group">
                            <label class="col-lg-3 control-label">邓小平理论</label>
                            <div class="col-lg-5">
                                <input id="dxp" type="text" class="form-control" name="dxp" />
                            </div>
                        </div>
                            <div class="form-group">
                            <label class="col-lg-3 control-label">中国近现代史</label>
                            <div class="col-lg-5">
                                <input id="zgls" type="text" class="form-control" name="zgls" />
                            </div>
                        </div>
...
$( function(){
	...
	$("#english").val('${sco.english}');
	$("#math").val('${sco.math}');
	$("#xxds").val('${sco.xxds}');
	$("#mzd").val('${sco.mzd}');
	$("#dxp").val('${sco.dxp}');
	$("#computer").val('${sco.computer}');
	$("#zgls").val('${sco.history}');
});
